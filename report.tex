...
\begin{figure}[H]
    \centering
    \vspace{0.5cm}
    \includegraphics[width=0.75\textwidth]{image/Error variability for CR across 10 seeds.png}
...
\begin{figure}[H]
    \centering
    \vspace{0.5cm}
    \includegraphics[width=0.75\textwidth]{image/Error variability for RE across 10 seeds.png}
