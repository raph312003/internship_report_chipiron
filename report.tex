...
% Normalization
An other important part in the preprocessing stage is the Normalization. In fact it's important to apply the same normalization on each sampled. This stage is very important because it puts all the samples in the same scales. Most of the time it's good to have a normalization between 0 and 1. We use this scale because in deep leraning model we used activation function and for example if you take the the sigmoid function 
% undersampling
