...
\includepdf[pages=1]{image/Rapport de stage de fin détudes Page de Garde - Promo 2026.pdf}
...
At Chipiron there are different hosting departments the main ones are the hardware team and software team.
My hosting department is the software team and in the software team I was part of the AI team. 
The software team is composed of 4 peoples: Nina Gidel-Dissier, who is the AI Engineering Manager, Guillaum Daval-Frérot and Angelo Franciosini who are both my supervisors.

\begin{figure}[H]
    \centering
    \vspace{0.5cm}
    \includegraphics[width=0.75\textwidth]{image/Lucca - Employees Chart.png}
...
Chipiron is integrating CSR in it's development strategy.
\paragraph{accountability}
\paragraph{transparency}
\paragraph{ethical behaviour}
\paragraph{respect for stakeholder interests}
\paragraph{respect for the rule of law}
\paragraph{respect for international norms of behaviour}
...
\begin{itemize}
    \item \textbf{Week 1-2:} Literature review (focus on "Reference-based MRI Reconstruction"). Setup Python environment.
    ...
    Establishes baseline performance using relevant metrics (PSNR, SSIM, RMSE), for undersampling and noise.
\end{itemize}

\paragraph{Months 2-4}

\begin{itemize}
    \item \textbf{Week 8-12:} Refine the architecture (e.g., try different blocks, loss functions, or MRI specific architecures).
