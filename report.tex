...
In the MAMA-MIA dataset~\cite{Mamamia}, the segmentation masks were initially generated automatically using a segmentation network and subsequently reviewed and corrected by multiple experts, resulting in highly accurate annotations.
