...
% Datasets
It was very important to structure my work by advancing step by step.
The goal is to start with a simple case and step by step we had some difficulties/ problematic wich will conduse a the end to our problematic.

First of all, the first step was to do some paper research.
\paragraph{Datasets}
\mbox{}\\
